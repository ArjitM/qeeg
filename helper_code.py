...
def load_recording_data(record_name, check_values=False):
    ...
    for i, l in enumerate(header):
        ...
        elif l.startswith("#Utility"):
            utility_frequency = get_utility_frequency(l)

        elif l.startswith("#Start"):
            start_time = get_start_time(l)

        elif l.startswith("#End"):
            end_time = get_end_time(l)
    ...
    return rescaled_data, channels, sampling_frequency, utility_frequency, start_time, end_time
